...
def main():
    ...
    features.append(Feature('race', ashley_values[6], X['race'].unique(), get_constant_category_weight_function(10.0, ashley_values[6]))) # really doesnt want to change race from original value
    features.append(Feature('gender', ashley_values[7], X['gender'].unique(), get_constant_category_weight_function(5, ashley_values[7]))) # gender too
